...
My work bridges technical innovation and business value by focusing on production-ready AI pipelines, governed workflows, and automation-first design.`,
  ...
  experience: [
    {
      ...
      startDate: "2025",
      endDate: "Present",
      description: "Leading development of advanced GenAI and risk analytics solutions.",
      technologies: ["GenAI", "LLMs", "RAG", "Python"]
    },
    {
      role: "Asst. Manager",
      company: "Genpact",
      ...
      startDate: "Nov 2023",
      endDate: "2025",
      description: "Built GenAI, Agentic AI, and RAG-powered tools for risk assessments. Developed ETL pipelines and enterprise AI solutions.",
      technologies: ["Python", "SQL", "Airflow", "Snowflake", "Azure", "GenAI", "RAG", "Power BI"]
    },
    {
    ...
    },
    {
      ...
      startDate: "Apr 2021",
      endDate: "Apr 2022",
      description: "Performed complex ETL using Hadoop, SQL, and Python. Built ML predictive models.",
      technologies: ["Hadoop", "SQL", "Python", "ML"]
    }
  ],
  ...
  education: {
    ...
    institution: "Government College of Engineering, Jalgaon, India",
    year: "2019"
  },
